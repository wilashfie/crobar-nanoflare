...
#@processify
def compute_loop_profiles(loopindex,loops,hterms,loopid_info,lbin_cents,segment_relareas,segment_heights,loop_amaxes,area_norms,time_indices=None):
